---- MODULE Ownership_TTrace_1788596880 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Ownership_TTrace_1788596880.json", _TETrace)
...
\*
\*trace == IODeserialize("Ownership_TTrace_1788596880.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Ownership_TTrace_1788596880 ----
CONSTANTS
    C0 = "foreign"
    C1 = "repoA"
    C2 = "repoB"
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Sep 05 08:28:00 UTC 2026