...
| M0-1.2e | NEXT / M0 | Join real PATH/GH_HOST/HTTP probes, ordinary child env, E400 terminal/JSON, production host selector and `CredentialRouting.tla` operator-audience/no-cleartext transitions with a named repo-audience mutant. | **In progress**, not an M0 or release closure: source-bound report `verification/reports/2026-09-26-m0-env-1c693ef.log` at commit `1c693ef` and fingerprint `9a82d56b48bef69d8a57c831a3efa16638123279150689d277ecdd8a81447825` binds two Rust and ten real CLI tests **12/12**, plus fresh TLC positive/three named mutant cfgs **4/4**, zero skipped. Original PATH/GH_HOST attacks were reproduced before fixing. | Final full-source e2e, protected CI/native Mac and R5/M-V7 proof-to-effect boundaries are missing; all plan/0048 NEXT work and original 178-ID handover remain blocking. |
