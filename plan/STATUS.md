...
| 0052 | A1 workspace contract: v4 history, v5 typed admission and partial graph/command/diagnostic gates | (pending) | Strict v3 modules and read-only v4 workspace retained; current v5 schema/Rust/TS adds typed targets/layouts, distinct graph roles and E124 before workspace effects. A1-02 base Linux compose passed Rust, TS 61/61, e2e 262/262, fresh Verus 61/0 with five mutants (TLC cached); later role-cardinality admission rejects omitted build/runtime edges with E131, not a full name-index proof. A1-03 fluent/object commands and literal source-mapped Bash passed Linux compose e2e 264/264. A1-06 adds structured frontend/core diagnostic parity in `grip check --json`, repo-capability-bounded snippets (1 MiB), and source labels; A1-07 expands calibrated architecture checks to every Cargo workspace member including fuzz. Latest Linux compose passed Rust fmt/clippy/tests, fresh e2e 275/275 and Verus 61/0 with five mutants; Deno 62/62 passed fresh in the focused gate, final TS/model layers cached. No workspace execution | A1-01 implemented_unverified; A1-02/A1-03/A1-06/A1-07 in_progress (schema→adapter refinement, pinned Bash/options, per-capability E124, golden/registry/CI/Mac evidence); A1-04/05/08–12 and plan/0048 NEXT remain open; no release |
