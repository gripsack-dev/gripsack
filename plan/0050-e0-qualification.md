...
The **systemd-linux lane alone is verified** at source `ce3c7e0`.
...
`Restart=no`, fired **0.995 seconds** after the requested local
...
checks pass. Earlier `0be1eaa`, `6909bbc`, `fc67212` and the
2026-09-24 Markdown observation remain historical.
...
| E0-02 systemd lane | verified at `ce3c7e0`: real transient user-manager calendar trigger, bounded observation and zero residue in SHA-256 runner report |
